    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <jsp:include page="/admin/top-bar.jsp" />
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Create New Quiz</h1>
                        ...
                        <div class="card-body">
                        	<form action="addQuiz" method="post">
                        		<div class="form-group">
                        			...
                        			<input type="text" id="quizTitle" name="quizTitle"  class="form-control" placeholder="Quiz Title"/>
                        		</div>
                        		<div class="form-group">
